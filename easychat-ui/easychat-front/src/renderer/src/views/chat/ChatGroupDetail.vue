<template>
  <div class="group-panel">
    <el-drawer v-model="showDrawer" model-class="mask-style" :size="300" ref="drawerRef">
...
const show = async (groupId) => {
  ...
  memberList.value = resp.data.userContactList
  groupInfo.value = resp.data.groupInfo
}
